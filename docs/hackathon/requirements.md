...
- The user/team captain retains ownership of reviewer data access, current event rules and submission. Raw data is not redistributed or pushed. No hosting requirement is inferred.
